...
public class ProductService {
    ...
    public ProductResponseDTO getProductById(Integer id){
        return toResponseDTO(productRepository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "product not found")));
    }
    ...
    public ProductResponseDTO updateProduct(Integer id, ProductRequestDTO dto){
        Product entity = productRepository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "product not found"));
